...
Per default the agents control the characters. For manual controll disable the agent script and enable the player controll script of a character in the editor.
